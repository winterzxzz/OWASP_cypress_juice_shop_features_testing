...
describe('Kiểm thử chức năng mua hàng', () => {
  ...
  it.only('DH_17 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập country là kí tự đặc biệt', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_21 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập độ dài mobile number đúng tối thiểu', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_26 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập mobile number với ký tự . ở cuối', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_27 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập mobile number chứa các kí tự chữ', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_28 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập mobile number với ký tự + ở đầu', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_30 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập zip code với các kí tự đặc biệt', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_31 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập zip code với các kí tự chữ', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_36 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập country là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_37 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập name là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_38 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập zipcode là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_39 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập address là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_40 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập city là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_41 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập city là kí tự đặc biệt', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_42 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập state là kí tự đặc biệt', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    cy.goToSelectAddress();
    cy.goToAddNewAddress();
  ...
  it.only('DH_50 - Kiểm thử thêm thẻ thanh toán mà nhập Name là khoảng trắng', () => {
    cy.addProductToCart('Banana Juice');
    cy.goToCartPage();
    // chọn địa chỉ
    cy.goToSelectAddress();
