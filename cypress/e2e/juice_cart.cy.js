describe('Juice Shop Cart Tests', () => {
  ...
  context('2️⃣ Khi đã đăng nhập', () => {
    ...
    it('TC38 - Kiểm thử thêm thẻ thanh toán mà không nhập Name', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC39 - Kiểm thử thêm thẻ thanh toán mà không nhập Card Number', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC40 - Kiểm thử thêm thẻ thanh toán mà không nhập Expiry Month', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC41 - Kiểm thử thêm thẻ thanh toán mà không nhập Expiry Year', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC42 - Kiểm thử thêm thẻ thanh toán mà nhập Name là khoảng trắng', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC43 - Kiểm thử thêm thẻ thanh toán mà nhập Card Number là khoảng trắng', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC44 - Kiểm thử thêm thẻ thanh toán mà nhập độ dài Card Number < 16', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC46 - Kiểm thử nhập coupon khi mua hàng mà coupon không hợp lệ', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC47 - Kiểm thử nhập coupon khi mua hàng mà độ dài coupon < 10', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC49 - Kiểm thử nhập coupon khi mua hàng mà coupon hợp lệ', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
    ...
    it('TC50 - Kiểm thử thanh toán thành công khi mua hàng', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      // chọn địa chỉ
      cy.goToSelectAddress();
