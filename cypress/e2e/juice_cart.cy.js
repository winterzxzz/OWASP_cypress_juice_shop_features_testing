describe('Juice Shop Cart Tests', () => {
  ...
  context('2️⃣ Khi đã đăng nhập', () => {
    ...
    it('TC19 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập độ dài mobile number < 7', () => {
      cy.addProductToCart('Banana Juice');
      cy.goToCartPage();
      cy.goToSelectAddress();
      cy.goToAddNewAddress();
    ...
    // it('TC20 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập độ dài mobile number > 10', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC30 - Kiểm thử nhập địa chỉ mua hàng mới mà không nhập city', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC31 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập country là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC32 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập name là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC33 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập zipcode là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC34 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập address là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC35 - Kiểm thử nhập địa chỉ mua hàng mới mà nhập city là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   cy.goToSelectAddress();
    //   cy.goToAddNewAddress();
    ...
    // it('TC36 - Kiểm thử phương thức giao hàng khi mua hàng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC37 - Kiểm thử phương thức thanh toán khi mua hàng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC38 - Kiểm thử thêm thẻ thanh toán mà nhập đầy đủ thông tin', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC39 - Kiểm thử thêm thẻ thanh toán mà không nhập Name', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC40 - Kiểm thử thêm thẻ thanh toán mà không nhập Card Number', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC41 - Kiểm thử thêm thẻ thanh toán mà không nhập Expiry Month', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC42 - Kiểm thử thêm thẻ thanh toán mà không nhập Expiry Year', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC43 - Kiểm thử thêm thẻ thanh toán mà nhập Name là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC44 - Kiểm thử thêm thẻ thanh toán mà nhập Card Number là khoảng trắng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC45 - Kiểm thử thêm thẻ thanh toán mà nhập độ dài Card Number < 16', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC46 - Kiểm thử thêm thẻ thanh toán mà nhập độ dài Card Number > 16', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC47 - Kiểm thử nhập coupon khi mua hàng mà coupon không hợp lệ', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC48 - Kiểm thử nhập coupon khi mua hàng mà độ dài coupon < 10', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC49 - Kiểm thử nhập coupon khi mua hàng mà độ dài coupon > 10', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC50 - Kiểm thử nhập coupon khi mua hàng mà coupon hợp lệ', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC51 - Kiểm thử thanh toán thành công khi mua hàng', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
    ...
    // it('TC52 - Kiểm thử thanh toán thành công khi mua hàng với mã giảm giá hợp lệ', () => {
    //   cy.addProductToCart('Banana Juice');
    //   cy.goToCartPage();
    //   // chọn địa chỉ
    //   cy.goToSelectAddress();
